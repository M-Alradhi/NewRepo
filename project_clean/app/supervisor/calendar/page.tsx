    ...
    <DashboardLayout sidebarItems={supervisorSidebarItems} requiredRole="supervisor">
      <div className="p-8 space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-2">جميع المهام والاجتماعات في مكان واحد</p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {selectedDate && (
              <Card className="lg:col-span-3 rounded-xl">
                <CardHeader>
                  <CardTitle>أحداث {formatArabicDate(selectedDate)}</CardTitle>
                </CardHeader>
                <CardContent>
                  {selectedDateEvents.length === 0 ? (
                    <p className="text-center text-muted-foreground py-8">لا توجد أحداث في هذا اليوم</p>
                  ) : (
                        ...
                        <Card key={event.id}>
                          ...
                          <CardContent className="space-y-2">
                            <div className="flex items-center gap-2 text-sm text-muted-foreground">
                              ...
                              {event.duration && ` (${event.duration} دقيقة)`}
                            </div>
                            {event.location && (
                              <div className="flex items-center gap-2 text-sm text-muted-foreground">
